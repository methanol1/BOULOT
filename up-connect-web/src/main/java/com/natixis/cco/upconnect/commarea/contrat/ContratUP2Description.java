...
public class ContratUP2Description {
	/* Partie commune */		
	 ...
	 */
	@UnitedCommareaField(position = 27, longueur = 3)
	private String numSocieteCommercial;
	
	/* Partie revolving */		
	
	@UnitedCommareaField(position = 28, longueur = 3)
	 ...
	 * Durée restante
	 */
	@UnitedCommareaField(position = 29, longueur = 3)
	private String 	dureeRestante;
	
	/**
	 * EIMVCTR-OUT-DPRJK
	 */
	@UnitedCommareaField(position = 30, longueur = 10)
	 ...
	 */
	@UnitedCommareaField(position = 31, longueur = 1)
	private String 	indicateurDtsActif;
	
	/**
	 * EIMVCTR-OUT-INDFINANC
	 */
	@UnitedCommareaField(position = 32, longueur = 15)
	private String 	indicateurFinancabilite;
	
	/**
	 * EIMVCTR-OUT-MNTDUDISPO
	 */
	@UnitedCommareaField(position = 33, longueur = 13)
	private String 	montantDisponible;
	
	/**
	 * EIMVCTR-OUT-NDMA
	 */
	@UnitedCommareaField(position = 34, longueur = 13)
	private String 	nouveauDMA;
	
	/**
	 * EIMVCTR-OUT-MNTDMA
	 */
	@UnitedCommareaField(position = 35, longueur = 13)
	 ...
	 */
	@UnitedCommareaField(position = 36, longueur = 1)
	 ...
	 */
	@UnitedCommareaField(position = 38, longueur = 10)
	 ...
	 */
	@UnitedCommareaField(position = 39, longueur = 10)
	 ...
	 */
	@UnitedCommareaField(position = 40, longueur = 10)
	 ...
	 */
	@UnitedCommareaField(position = 43, longueur = 13)
	 ...
	 */
	@UnitedCommareaField(position = 44, longueur = 13)
	 ...
	 */
	@UnitedCommareaField(position = 46, longueur = 3)
	 ...
	 */
	@UnitedCommareaField(position = 47, longueur = 3)
	 ...
	 */
	@UnitedCommareaField(position = 48, longueur = 13)
	 ...
	 */
	@UnitedCommareaField(position = 49, longueur = 3)
	 ...
	 */
	@UnitedCommareaField(position = 50, longueur = 10)
	private String 	dateFin;
	
	/**
	 * EIMVCTR-OUT-DPROCHEMENS
	 */
	@UnitedCommareaField(position = 51, longueur = 10)
	private String 	dateProchaineEcheance;
	
	/**
	 * EIMVCTR-OUT-MNTPROCHEME-NS
	 */
	@UnitedCommareaField(position = 52, longueur = 13)
	 ...
	 */
	@UnitedCommareaField(position = 53, longueur = 1)
	 ...
	 */
	@UnitedCommareaField(position = 54, longueur = 1)
	...
	public void setDateSignatureOuPremierFin(String dateSignature) {
		this.dateSignatureOuPremierFin = dateSignature;
	}
