package com.natixis.cco.upconnect.modelUP.rachat;

public class OutputRachatUP1 {
	...
	public String getTauxIra() {
		return tauxIra;
	}

	public void setTauxIra(String tauxIra) {
