package com.natixis.cco.upconnect.commarea;
...
/**
 * Cette classe contient toutes les informations de l'entête d'un appel ou d'une réponse UNITED
 * 
 * Dans la version actuelle, nous avons un header de 130
 * 
 * Il se peut que cette class évolue nous aurons alors à gérer des versions.
 */
public class UnitedCommareaDescriptionHeader implements UnitedCommareaDescription {
